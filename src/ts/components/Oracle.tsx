		...
		return <Layout>
				...
				{res !== undefined && Object.keys(this.props.res).length > 0 ? [<div style={{ margin: '10px' }}>
							<SDivFlexCenter center horizontal marginBottom="10px;">
								<PriceColumn className={'left top'} name={res[Object.keys(res)[0] as any].relayerID} price={res[Object.keys(res)[0] as any].price} stack={2} yourStack={res[Object.keys(res)[0] as any].price} account={account} />
							...
							</SDivFlexCenter>,<SDivFlexCenter center horizontal marginBottom="10px;">
